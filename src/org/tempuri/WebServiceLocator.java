...
public class WebServiceLocator extends org.apache.axis.client.Service implements org.tempuri.WebService {
    ...
    private java.lang.String WebServiceSoap_address = "http://sdk2.zucp.net:8060/webservice.asmx";
    ...
    public org.tempuri.WebServiceSoap getWebServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public org.tempuri.WebServiceSoap getWebServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.tempuri.WebServiceSoapStub _stub = new org.tempuri.WebServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.tempuri.WebServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                org.tempuri.WebServiceSoapStub _stub = new org.tempuri.WebServiceSoapStub(new java.net.URL(WebServiceSoap_address), this);
                _stub.setPortName(getWebServiceSoapWSDDServiceName());
                return _stub;
            }
        }
