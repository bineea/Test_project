...
public interface WebServiceSoap extends java.rmi.Remote {
    ...
    /**
     * 软件序列号注册：sn软件序列号;pwd序列号密码;province省;city城市;trade行业;entname企业名称;linkman联系人;phone联系电话;mobile移动电话;email邮件地址;fax传真;address地址;postcode邮政编码;sign签名
     */
    ...
    /**
     * 传真发送：sn软件序列号;pwd加密密码md5(sn+password);title传真主题;mobile接收号码,以英文逗号隔开;content文件内容,base64编码(文件base64编码串);srcnumber发送号码;stime定时时间2010-07-05
     * 17:37:00.返回:rrid
     */
